...
MODEL_PATH_PRO = "/data/gzb/code/DebateAgents/output/qwen-1.5B-finetune/ckpt_merged"  # 正方模型 (SFT)
MODEL_PATH_CON = "/data/gzb/code/DebateAgents/output/qwen-1.5B-finetune/ckpt_merged"  # 反方模型 (SFT)
# MODEL_PATH_CON = "/data/gzb/modelzoo/Qwen2.5-1.5B"
# MODEL_PATH_PRO = "/data/gzb/modelzoo/Qwen2.5-1.5B"
